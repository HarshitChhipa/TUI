...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.onSubmit = function () {
        ...
        this.loading = true;
        this.authService.login(this.f.email.value, this.f.password.value).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["first"])()).subscribe(function (data) {
            console.log(_this.returnUrl, 'This is return URL');
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(tweetService, authService) {
        this.tweetService = tweetService;
        this.authService = authService;
        this.idToken = this.authService.currentUserValue.idToken;
    }
    HomeComponent.prototype.ngOnInit = function () {
        this.tweetService.getAllTweet(this.idToken).subscribe(function (res) {
...
var TweetServiceService = /** @class */ (function () {
    function TweetServiceService(http) {
        this.http = http;
    }
    TweetServiceService.prototype.getAllTweet = function (authToken) {
    ...
    TweetServiceService.ctorParameters = function () { return [
